...
| gateway.enabled                            | bool   | `false`             | Create a Gateway object if set to `true`.                                                                                                                                                                                                                                                                                                                 |
| gateway.className                          | string | `""`                | Name of an existing Gateway Class. Must not be empty.                                                                                                                                                                                                                                                                                                     |
| gateway.labels                             | object | `{}`                | Extra labels to add to the Gateway.                                                                                                                                                                                                                                                                                                                       |
| gateway.annotations                        | object | `{}`                | Annotations to add to the Gateway.                                                                                                                                                                                                                                                                                                                        |
| listener.port                              | string | `80`                | Listener port.                                                                                                                                                                                                                                                                                                                                            |
| listener.allowedRoutes                     | object | `{}`                | Routes that are allowed to be attached to the Listener.                                                                                                                                                                                                                                                                                                   |
| listener.tls.enabled                       | bool   | `false`             | Enable TLS support.                                                                                                                                                                                                                                                                                                                                       |
| listener.tls.certificateRefs               | object | []                  | List of attached certificates.                                                                                                                                                                                                                                                                                                                            |
| httpRoute.enabled                          | bool   | `false`             | Enable HTTPRoute.                                                                                                                                                                                                                                                                                                                                         |
| httpRoute.labels                           | object | `{}`                | Extra labels to add to the HTTPRoute.                                                                                                                                                                                                                                                                                                                     |
| httpRoute.hostnames                        | list   | `[ollama.local]`    | List of hostnames attached to the HTTPRoute.                                                                                                                                                                                                                                                                                                              |
| httpRoute.parentRefs                       | list   | `[]`                | List of existing Gateway(s) that this HTTPRoute attach to. This attribute is ignored if `gateway.enabled` is `true`.                                                                                                                                                                                                                                      |
| httpRoute.rules                            | list   | `[]`                | Routing rules. If empty, a default rule routing all requests to the Ollama service is created.                                                                                                                                                                                                                                                            |
...
| podSchedulerName                           | string | `""`                | Scheduler Name e.g. "kai-scheduler". See https://github.com/kai-scheduler/KAI-Scheduler                                                                                                                                                                                                                                                                   |
