...
When `knative.enabled=true`, this chart deploys a Knative `Service` instead of a standard Kubernetes `Deployment` and
`Service`.
...
If your Knative installation is managed by the Knative Operator, configure these feature flags on the `KnativeServing`
resource instead of patching the ConfigMap directly.
...
When `knative.enabled=true` and model bootstrap is configured with `ollama.models.pull`, `ollama.models.run`, or
`ollama.models.create`, the chart renders a separate bootstrap `Job`.

- The Job is non-blocking: `helm install` and `helm upgrade` do not wait for model preload to finish.
- The Job name includes a hash of `ollama.models.pull`, `ollama.models.run`, `ollama.models.create`, and
  `ollama.models.clean`, so changing those settings on upgrade creates a new Job and reruns bootstrap.
- Completed bootstrap Jobs are cleaned up according to `knative.modelBootstrap.ttlSecondsAfterFinished`.
- Knative bootstrap requires `persistentVolume.enabled=true` so the bootstrap Job and Knative `Service` can share the
  same model data.
...
| gateway.className                              | string | `""`                                                                          | Name of an existing Gateway Class. Mandatory non-empty field                                                                                                                                                                                                                                                                                              |
| gateway.enabled                                | bool   | `false`                                                                       | Create Gateway if gateway.enabled = true. Otherwise, httpRoute will need parentRefs to attach to an existing Gateway.                                                                                                                                                                                                                                     |
| gateway.labels                                 | object | `{}`                                                                          | Labels to add to the Gateway                                                                                                                                                                                                                                                                                                                              |
| gateway.listener                               | object | `{"allowedRoutes":{},"port":80,"tls":{"certificateRefs":[],"enabled":false}}` | Configure the listener                                                                                                                                                                                                                                                                                                                                    |
| gateway.listener.allowedRoutes                 | object | `{}`                                                                          | Define which Routes may be attached to this Listener                                                                                                                                                                                                                                                                                                      |
| gateway.listener.port                          | int    | `80`                                                                          | Listener network port. May depend on implementation (eg. Traefik)                                                                                                                                                                                                                                                                                         |
| gateway.listener.tls                           | object | `{"certificateRefs":[],"enabled":false}`                                      | TLS configuration                                                                                                                                                                                                                                                                                                                                         |
| gateway.listener.tls.certificateRefs           | list   | `[]`                                                                          | See https://gateway-api.sigs.k8s.io/reference/spec/#secretobjectreference                                                                                                                                                                                                                                                                                 |
| gateway.listener.tls.enabled                   | bool   | `false`                                                                       | Enable TLS                                                                                                                                                                                                                                                                                                                                                |
| gateway.name                                   | string | `""`                                                                          | Name of the Gateway. Defaults to the chart's full name if empty                                                                                                                                                                                                                                                                                           |
...
| httpRoute.hostnames                            | list   | `["ollama.local"]`                                                            | Hostnames to match for this HTTPRoute                                                                                                                                                                                                                                                                                                                     |
| httpRoute.labels                               | object | `{}`                                                                          | Labels to add to the HTTPRoute                                                                                                                                                                                                                                                                                                                            |
| httpRoute.parentRefs                           | list   | `[]`                                                                          | See https://gateway-api.sigs.k8s.io/reference/spec/#parentreference                                                                                                                                                                                                                                                                                       |
| httpRoute.rules                                | list   | `[]`                                                                          | See https://gateway-api.sigs.k8s.io/reference/spec/#httprouterule                                                                                                                                                                                                                                                                                         |
